...
namespace lilia::app::controller
{
  ...
  UiEventSystem::UiEventSystem(view::ui::GameView &view, chess::ChessGame &game, HistorySystem &history,
  ...
  bool UiEventSystem::handleEvent(const sf::Event &event)
  {
    ...
    if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
    {
      ...
      switch (opt)
      {
      case view::ui::MoveListView::Option::Resign:
        m_view.showResignPopup();
        return true;

      case view::ui::MoveListView::Option::Prev:
        m_history.stepBackward(m_premove);
        return true;

      case view::ui::MoveListView::Option::Next:
        m_history.stepForward(m_premove);
        return true;

      case view::ui::MoveListView::Option::Settings:
        // Placeholder / future hook
        return true;

      case view::ui::MoveListView::Option::NewBot:
        m_next_action = NextAction::NewBot;
        return true;

      case view::ui::MoveListView::Option::Rematch:
        m_next_action = NextAction::Rematch;
        return true;

      case view::ui::MoveListView::Option::ShowFen:
