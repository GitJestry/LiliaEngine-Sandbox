...
namespace lilia::app::view::ui
{
  ...
  BoardNode::BoardNode(MousePos pos) : Entity(pos), m_flipped(false) {}

  MousePos BoardNode::boardOffset() const
  {
    return {
  ...
  void BoardNode::positionLabels(MousePos board_offset)
  {
  ...
  void BoardNode::rebuildLabelTextures(sf::Color outlineCol)
  {
  ...
  void BoardNode::init(const sf::Texture &textureWhite, const sf::Texture &textureBlack,
  ...
  void BoardNode::setLabelOutline(sf::Color outline)
  {
  ...
  MousePos BoardNode::getPosOfSquare(chess::Square sq) const
  {
    return m_squares[static_cast<size_t>(sq)].getPosition();
  }

  void BoardNode::draw(sf::RenderWindow &window)
  {
    Entity::draw(window);
  ...
  void BoardNode::setPosition(const MousePos &pos)
  {
  ...
  void BoardNode::setFlipped(bool flipped)
  {
    m_flipped = flipped;
    setPosition(getPosition());
  }

  bool BoardNode::isFlipped() const
  {
    return m_flipped;
  }
