#include "lilia/app/view/ui/style/modals/game_setup/game_setup_page_builder.hpp"

namespace lilia::app::view::ui::game_setup
{
  PageBuilder::PageBuilder(const sf::Font &font, const Theme &theme)
  ...
  void PageBuilder::updateHover(MousePos mouse)
  {
    m_builder.updateHover(mouse);
  }

  bool PageBuilder::handleEvent(const sf::Event &e, MousePos mouse)
  {
