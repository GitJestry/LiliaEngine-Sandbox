...
#include "uci_engine_process.hpp"
...
namespace lilia::app::engines
{
  struct EngineEntry
  {
    ...
    std::vector<domain::analysis::config::UciOption> options;
  ...
  public:
    ...
    domain::analysis::config::BotConfig makeDefaultBotConfig(const std::string &engineId) const;
